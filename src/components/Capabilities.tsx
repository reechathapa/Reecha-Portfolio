...
export default function Capabilities() {
  ...
  return <section className="capabilities-section section-pad" id="expertise" aria-labelledby="expertise-heading"><div className="container">
    <div className="capabilities-grid"><Reveal className="capabilities-intro"><SectionLabel number="04">THE RIGHT KIND OF EXPERTISE</SectionLabel><h2 id="expertise-heading">The right mix.<br />Not more of<br /><span className="serif">everything.</span></h2><p>Good SEO isn’t a checklist. It’s knowing which pieces matter, how they connect, and where to focus next.</p><a href="#intent" className="text-link">See how I connect the dots <ArrowUpRight size={16} /></a></Reveal>
